...
This repository contains the source code of the agent plugin for the AWS Redshift integration.

Learn more about the AWS Redshift integration [here](https://docs.superblocks.com/integrations/connect-integrations/redshift).
